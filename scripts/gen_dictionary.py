...
SRC_TOKENS = ["MAIB", "Pipeline", "AI-U", "AI-V", "System", "UNCLEAR"]
BADGE_CLASS = {"MAIB": "maib", "Pipeline": "pipe", "AI-U": "aiu",
               "AI-V": "aiv", "System": "sys", "UNCLEAR": "unc"}
...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .src--maib { background: #e7eef7; color: #15375e; }
  ...
  <body>
    ...
    <div class="intro-wide">
      <div class="intro-wide__inner">
        ...
        <p class="lede">Every table and column in the CHIRPdb database - with, for each field, whether it came from MAIB source data, was derived by the pipeline, or was generated by AI, and whether a human has verified it. A reference to dip into, not read cover to cover. See the <a href="index.html">dataset overview</a> for orientation and the schema diagram.</p>
      </div>
    </div>
    <div class="layout">
      __TOC__
